...
const categories = [
  ...
  { name: 'Чохли та аксесуари', image: "https://images.unsplash.com/photo-1541807084-5c52b6b3adef?w=150&auto=format&fit=crop&q=60" },
  { name: 'Книги та розваги', image: "https://images.unsplash.com/photo-1578632767115-351597cf2477?w=150&auto=format&fit=crop&q=60" },
  { name: 'Парфумерія', image: "https://images.unsplash.com/photo-1541643600914-78b084683601?w=150&auto=format&fit=crop&q=60" },
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-40 shadow-sm">
        <div className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between gap-4">
          ...
          <form onSubmit={handleSearchSubmit} className="flex flex-1 max-w-xl items-center border border-slate-300 rounded-lg bg-[#f4f4f4] focus-within:border-purple-600 focus-within:bg-white transition-all">
            <input
              type="text" placeholder="Я шукаю..." value={searchQuery}
